const BusinessCard = () => {
    return (
        <div className=" grid grid-cols-2  sm:py-12 overflow-hidden w-full">
            ...
            <div className="flex items-center justify-center border-r-4 h-62 w-32 mt-8 border-white lg:h-96 lg:mt-20 lg:w-full">
            ...
            <div className="flex flex-col gap-4 justify-between lg:px-10 lg:h-96 lg:mt-20 w-full -mx-6 ">
                ...
                <div className=" flex flex-col lg:gap-4 lg:mb-10 mb-20 -mx-1 lg:-mx-4">
